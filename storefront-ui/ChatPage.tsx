...
const PREVIEW_PRODUCT_1 = {
  ...
  description:
    "A timeless essential made from 100% organic cotton. Comfortable fit for everyday wear.",
  imgUrl: _IMG_TEE,
  images: [
...
const PREVIEW_PRODUCT_HERO = {
  ...
  description:
    "Handcrafted merino wool cap, perfect for the colder months. One size fits all. Made in Italy.",
  imgUrl: _IMG_CAP,
  images: [
...
const PREVIEW_COLLECTION = {
  ...
  description:
    "A curated selection of lightweight pieces perfect for the warm season.",
  ...
  products: [
    ...
    PREVIEW_PRODUCT_3,
    {
      ...
      title: "Linen Shorts",
      imgUrl: _IMG_CAP,
      url: "https://example.myshopify.com/products/linen-shorts",
      price: { amount: "55.00", currencyCode: "EUR" },
    },
  ],
};
...
const PREVIEW_VARIANT_PRODUCT = {
  ...
  description:
    "Lightweight performance running shoe with breathable mesh upper and responsive foam sole.",
  images: [
...
const PREVIEW_SECTION_MESSAGE = {
  ...
  parts: [
    {
      type: "text",
      text: "Ciao! Ho selezionato alcune opzioni in linea con il tuo stile. Dai un'occhiata ai prodotti qui sotto — fammi sapere se vuoi approfondire qualcosa.",
    },
  ],
  createdAt: new Date(),
