...
const SHOPIFY_SHOP= 'conversational-commerce-67y9bqti'
const SHOPIFY_PUBLIC_STOREFRONT_ACCESS_TOKEN = 'c737574b789291fdc38e77a0f4b5d30f'
...
export async function fetchCart(rawCartId: string) {
    ...
    const token = SHOPIFY_PUBLIC_STOREFRONT_ACCESS_TOKEN!
...
// todo pensare meglio. per ora ho copia incollato quella dentro a execute.ts di cart. (issue #66 e 65)
